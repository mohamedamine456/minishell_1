...
SRC = fatal_error.c test_functions.c command_parser.c fill_command.c remove_tab_from_string.c check_functions/*.c allocation_functions.c libft/*.c get_next_line/get_next_line.c commands_list/*.c
